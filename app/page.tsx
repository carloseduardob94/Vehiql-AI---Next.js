        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Verified listings and secure booking process for aeace of mind.</p>
            </div>
          </div>
            ...
            {bodyTypes.map((type) => (
              <Link key={type.name} href={`/cars?bodyType=${type.name}`} className="relative group cursor-pointer">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent rounded-lg flex items-end">
                  <h3 className="text-white text-xl font-bold pl-4 pb-2 font-medium">{type.name}</h3>
                </div>
              </Link>
            ))}
          </div>
